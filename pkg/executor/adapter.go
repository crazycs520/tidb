...
func (a *ExecStmt) SummaryStmt(succ bool) {
	...
	stmtExecInfo := stmtExecInfoPool.Get().(*stmtsummary.StmtExecInfo)
	...
	stmtExecInfoPool.Put(stmtExecInfo)
}

var stmtExecInfoPool = sync.Pool{
	New: func() interface{} {
		return new(stmtsummary.StmtExecInfo)
	},
}
