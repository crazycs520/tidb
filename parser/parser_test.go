...
func TestDDL(t *testing.T) {
	table := []testCase{
		...
		{"create table t (c int) PARTITION BY RANGE (Year(VDate)) INTERVAL 1 YEAR (PARTITION p1980 VALUES LESS THAN (1980), PARTITION p1990 VALUES LESS THAN (1990))", true, "CREATE TABLE `t` (`c` INT) PARTITION BY RANGE (YEAR(`VDate`)) INTERVAL 1 YEAR (PARTITION `p1980` VALUES LESS THAN (1980),PARTITION `p1990` VALUES LESS THAN (1990))"},
		{"create table t (c int) PARTITION BY RANGE (c) INTERVAL 1000 (PARTITION p1980 VALUES LESS THAN (1980), PARTITION p1990 VALUES LESS THAN (1990))", true, "CREATE TABLE `t` (`c` INT) PARTITION BY RANGE (`c`) INTERVAL 1000 (PARTITION `p1980` VALUES LESS THAN (1980),PARTITION `p1990` VALUES LESS THAN (1990))"},
