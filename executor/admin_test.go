...
func (s *testSuite) TestAdminCheckTable(c *C) {
	...
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx1 (c2, c3,c4,c5,c6)`)
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx2 (c2)`)
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx3 (c3)`)
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx4 (c4)`)
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx5 (c5)`)
	tk.MustExec(`ALTER TABLE t1 ADD UNIQUE INDEX uidx6 (c6)`)
