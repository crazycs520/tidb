...
const (
	...
	TableStatementsCost        = "STATEMENTS_COST"
	TableStatementsCostHistory = "STATEMENTS_COST_HISTORY"
)
...
var tableIDMap = map[string]int64{
	...
	TableStatementsCost:                     autoid.InformationSchemaDBID + 70,
	TableStatementsCostHistory:              autoid.InformationSchemaDBID + 71,
}
...
var tableStatementsCostCols = []columnInfo{
	{name: "BEGIN_TIME", tp: mysql.TypeTimestamp, size: 26, flag: mysql.NotNullFlag, comment: "Begin time of this summary"},
	{name: "END_TIME", tp: mysql.TypeTimestamp, size: 26, flag: mysql.NotNullFlag, comment: "End time of this summary"},
	...
	{name: "SUM_CPU_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag, comment: "Sum CPU time of these statements"},
	{name: "SUM_QUERY_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_PARSE_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_COMPILE_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_OPTIMIZE_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_WAIT_TS_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_COP_PROCESS_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_COP_WAIT_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_BACKOFF_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_PRE_WRITE_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_GET_COMMIT_TS_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_COMMIT_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
	{name: "SUM_RESOLVE_LOCK_TIME", tp: mysql.TypeLonglong, size: 20, flag: mysql.NotNullFlag | mysql.UnsignedFlag},
...
var tableNameToColumns = map[string][]columnInfo{
	...
	TableStatementsCost:                     tableStatementsCostCols,
	TableStatementsCostHistory:              tableStatementsCostCols,
}
